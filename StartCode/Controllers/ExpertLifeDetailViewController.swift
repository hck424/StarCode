...
class ExpertLifeDetailViewController: BaseViewController {
    ...
    func requestExpertLifeDetail() {
        ...
        self.postId = post_id
        ApiManager.shared.requestExpertLifeDetail(param: param) { (response) in
...
extension ExpertLifeDetailViewController: UITableViewDelegate, UITableViewDataSource {
...
extension ExpertLifeDetailViewController: TalkWriteViewControllerDelegate {
